...
import { Search, AlertCircle, TrendingUp, CheckCircle2, Loader2 } from 'lucide-react';
...
export function SymptomChecker() {
  ...
  const loadSymptoms = async () => {
    ...
    if (error) console.error('Error loading symptoms:', error);
  };
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-blue-50 to-green-50 border-2 border-blue-200 rounded-xl p-6">
              ...
              <div className="text-2xl font-bold text-gray-900 mb-3">{prediction.disease}</div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
              <p className="text-sm text-yellow-800">
                <strong>Disclaimer:</strong> This is an AI-powered prediction and should not replace professional medical advice. Please consult with a qualified healthcare provider for accurate diagnosis and treatment.
              </p>
            </div>
          </div>
